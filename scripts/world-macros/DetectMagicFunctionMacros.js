...
import {
    runDetectMagicRoll,
} from "./DetectMagicRollHelperMacros.js";

export async function runDetectMagic({
    behavior = null,
    event = null,
    region = null,
    scene = null,
...
for (const difficulty of DIFFICULTIES) {
    const entries =
        Array.isArray(config.skills?.[difficulty])
            ? config.skills[difficulty]
            : [];
 ...
 * A failed identification check is a normal successful execution.
 */
